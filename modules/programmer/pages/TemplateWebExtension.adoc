...
Проект "TemplateWebExtension" является частью репозитория link:{dv}RepOnGitHub.adoc[WebClient-Samples]. Данный проект предназначен для разработки и сборки клиентских расширений и скриптов.
