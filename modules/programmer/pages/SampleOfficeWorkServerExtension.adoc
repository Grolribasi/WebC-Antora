...
* возвращать год для определённой секции – нужно, если в программе _{kvr}_ был выбран раздел, из которого выбираются дела;
* возвращать все разделы для определённого года, а если требуется, только разделы из корневого раздела, выбранного в программе _{kvr}_;
...
* возвращать список дел с искомым названием, а если требуется, только дела из из корневого раздела, выбранного в программе _{kvr}_.
