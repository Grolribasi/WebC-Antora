...
Перечисление NotificationType определяет типы оповещений, которые могут быть отправлены с помощью сервиса link:Platform_WebClient_Services_IRealtimeCommunicationService.adoc[IRealtimeCommunicationService].
