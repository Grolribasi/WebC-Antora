= Разработка расширения для программы _DVWebTool_
...
.. Нажмите *File* → *Open* и выберите файл `&lt;Каталог установки {wc}а&gt;\Site\Content\Tools\_DVWebTool_\Application     Files\{dv}._DVWebTool_.exe.manifest`.
...
.. Нажмите *File* → *Open* и выберите файл `&lt;Каталог установки {wc}а&gt;\Site\Content\Tools\_DVWebTool_\{dv}._DVWebTool_.application`.
.. Перейдите в раздел Name и в поле Version увеличьте номер сборки. Например, «5.5.5531.0» до «5.5.5531.1». Не изменяйте мажорную и минорную версии, и версию исправления.
...
.. Перейдите в раздел Application Reference, нажмите кнопку *Select Manifest* и выберите файл `&lt;Каталог установки {wc}а&gt;\Content\Tools\_DVWebTool_\Application Files\{dv}._DVWebTool_.exe.manifest`. В поле Version будет указана версия , полученная при обновлении файла манифеста.
