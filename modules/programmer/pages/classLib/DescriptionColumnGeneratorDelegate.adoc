...
Пример метода для делегата `DescriptionColumnGeneratorDelegate` приведён в пункте xref:serverExtensionsLinksDescriptionGenerator.adoc[Разработка расширения для формирования описаний ссылок].
