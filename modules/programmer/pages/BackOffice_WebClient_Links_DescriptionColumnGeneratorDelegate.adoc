...
|sessionContext |Контекст сессии. Тип link:Platform_WebClient_SessionContext.adoc[SessionContext].
...
Пример метода для делегата DescriptionColumnGeneratorDelegate приведён в пункте link:LinksDescriptionGenerator.adoc[Разработка расширения для формирования описаний ссылок].