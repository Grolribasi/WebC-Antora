...
image::employeesEditMode.png[Элемент управления "Сотрудники" в режиме редактирования]
+
...
image::employeesPlaceMode.png[Элемент управления "Сотрудники" в режиме редактирования по месту]
+
...
.Заполнитель
image::employeesSampleEmpty.png[Заполнитель]
