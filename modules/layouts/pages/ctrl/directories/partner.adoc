...
image::partnerSelectorSample.png[Справочник контрагентов]
...
image::partnerEditMode.png[Элемент управления "Партнер" в режиме редактирования]
+
...
image::partnerPlaceMode.png[Элемент управления "Партнер" в режиме редактирования по месту]
+
