...
image::employeeEditMode.png[Элемент управления "Сотрудник" в режиме редактирования]
+
...
image::employeePlaceMode.png[Элемент управления "Сотрудник" в режиме редактирования по месту]
+
...
.Заполнитель
image::employeeSampleEmpty.png[Заполнитель]
