...
image::dropListModeEdit.png[Элемент управления "Раскрывающийся список" в режиме редактирования]
+
...
image::dropListModePlace.png[Элемент управления "Раскрывающийся список" в режиме редактирования по месту]
+
...
Список значений задается в форме, открываемой при нажатии кнопки image:buttons/dots.png[Три точки]:

.Настройка списка элементов элемента управления "Раскрывающийся список", связанного с полем типа "enum"
image::dropListItems.png[Настройка списка элементов элемента управления "Раскрывающийся список", связанного с полем типа "enum"]
...
Локализация элементов списка выполняется при нажатии кнопки image:buttons/dots.png[Три точки] в строке значения. Настройки локализации сохраняются после нажатия кнопки *ОК* в окне _Локализация элементов_.
