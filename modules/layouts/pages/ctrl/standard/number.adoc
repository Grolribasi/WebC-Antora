...
image::numberEditMode.png[Элемент управления "Число" в режиме редактирования]
+
...
image::numberPlaceMode.png[Элемент управления "Число" в режиме редактирования по месту]
+
