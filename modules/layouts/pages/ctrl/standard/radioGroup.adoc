...
image::radioGroupEditMode.png[Элемента управления "Группа радиокнопок" в режиме редактирования]
+
...
image::radioGroupPlaceMode.png[Элемент управления "Группа радиокнопок" в режиме редактирования по месту]
+
...
image::radioGroupItems.png[Настройка списка элементов элемента управления "Группа радиокнопок", связанного с полем типа "int"]
