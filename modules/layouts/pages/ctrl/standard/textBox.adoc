...
image::stringEditMode.png[Элемент управления "Строка" в режиме редактирования]
+
...
image::stringPlaceMode.png[Элемент управления "Строка" в режиме редактирования по месту]
+
