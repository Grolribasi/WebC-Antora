...
. Измените настройки элемента управления. Описание параметров элемента управления приведено в пункте xref:Control_webFrameUserPanel.html[Панель пользователя].
. Сохраните разметку.
