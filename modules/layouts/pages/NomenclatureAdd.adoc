...
Если нужно добавить ссылку на Справочник номенклатуры дел в другую разметку, для разметки необходим xref:solutionsChangeMode.adoc[режим управления решением] _Поставщик_.
