...
* xref:task_tcard_change_state_finish_performer.html[выполните и завершите задание];
* xref:task_tcard_change_state_delegate.html[делегируйте задание другому сотруднику];
* xref:task_tcard_change_state_reject_performer.html[отклоните задание].
